...
public interface FormFieldDefinition {
    ...
    public val rules: List<@Polymorphic ValidationRule>
    ...
    public val visibleIf: @Polymorphic FormCondition? get() = null
    ...
    public val triggersPatch: Boolean get() = false
    ...
    public val initialValue: @Polymorphic FieldValue? get() = null
}
