...
Доступность (accessibility) в самой студии по умолчанию выключена: Compose 1.11 на десктопе
падает при подключённом ассистивном клиенте — читалке экрана, оконном менеджере, инструменте
