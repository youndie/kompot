...
fun interface KompotComponentEventNaming {
    fun describe(component: KompotComponent): KompotEventDescriptor
}

fun interface KompotActionEventNaming {
    fun describe(action: KompotAction): KompotEventDescriptor
}

class KompotEventNamingRegistry(
