...
**Чего проверка не знает:** Android-таргет в дамп не попадает — KGP кладёт только `jvm`-половину
(`api/jvm/<module>.api`) и klib. Это граница механизма, а не недосмотр конфигурации.
"""
import os
import pathlib
import re
