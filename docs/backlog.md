...
|---|---|---|---|---|---|
| [B-40](backlog/B-40-compose-line-1-12.md) `[ ]` | Линия Compose 1.12: четыре числа одним коммитом | release-0.38 | P0 | L | — |
...
| [B-41](backlog/B-41-renovate-queue.md) `[ ]` | Очередь renovate разобрана до релиза: Kotlin 2.4.20, AGP 9.4.1, coil 3.6.3 | release-0.38 | P1 | S | — |
...
| [B-50](backlog/B-50-show-message-action.md) `[ ]` | show_message: короткое сообщение в ответ на действие | release-0.38 | P1 | S/M | — |
